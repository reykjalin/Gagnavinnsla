...
def plot_ar_all():
    plt.bar(arall, fjall, width=0.1, color='blue')
    plot_title.append('Menntun - Alls')
    legend_handles.append('Menntun - Alls')
def plot_ar_kk():
    plt.bar(arkk, fjkk, width=0.1, color='green')
    plot_title.append('Menntun - Karlar')
    legend_handles.append('Menntun - Karlar')
def plot_ar_kvk():
    plt.bar(arkvk, fjkvk, width=0.1, align='center', color = 'red')
    plot_title.append('Menntun - Konur')
    legend_handles.append('Menntun - Konur')
def plot_ar():
    plot_ar_all()
    plot_ar_kk()
    plot_ar_kvk()
