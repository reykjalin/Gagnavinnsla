...
Þegar staðsetningar sólmyrkvana er teiknuð á hnöttinn sást að hringir myndast á breiddargráðum 60$^{\circ}$-75$^{\circ}$ bæði á norður- (sjá mynd \ref{fig:3DNP}) og suðurhveli jarðar (sjá mynd \ref{fig:3DSP}) og sú lína spannar ca 43,6\% af öllum sólmyrkvunum sem hafa verið á jörðinni frá tímabilinu 1901 - 2100. Hægt er að sjá að á svæðum sem sólmyrkvarnir mynda þéttan kjarna að það eru mun færri stríð á þessum svæðum sbr. 60$^{\circ}$-75$^{\circ}$.

Einnig er hægt að sjá ef vel er rínt í mynd \ref{fig:3DNP} að nær engir sólmyrkvar eru alveg frá mið Asíu, niður með miðausturlöndunum og alveg inn í miðja Afríku. Einnig er það líka svæðið sem er með hæsta þéttleika átaka ef öll gögn gagnasafnsins eru teiknuð upp í einu. Út frá þessum gögnum er því hægt að draga huglæt álit á því að því fleiri átök á landsvæði, því færri sólmyrkvar. \textbf{Always stay on the dark side of life !}
\pagebreak
