...
Þegar plottaðir voru staðsetningarnar fyrir sólmyrkvana þá sást að lína myndaðist á breiddargráðum 60$^{\circ}$-75$^{\circ}$ bæði á norður- og suðurhveli og sú lína spannar ca 43,6\% af öllum sólmyrkvunum\ref{fig:3DNP}\ref{fig:3DSP} sem hafa verið á jörðinni frá tímabilinu 1901 - 2100. 
\pagebreak
