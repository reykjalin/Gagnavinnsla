...
\subsection{Hönnun}
Við notumst við Basemap\cite{basemap} sem er viðbótarpakki fyrir Matplotlib til að sýna hvernig sólmyrkvinn lendir á jörðinni. Gögnin um sólmyrkvan frá NASA eru notaðar til að sýna staðsetningarnar sólmyrkvana á jörðinni, það er notast við dagsetningar og tímasetningar þar sem sólmyrkvinn er sem mestur. 
\subsection{Aðferð}
%
